globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-0YdVIvFI.js","assets/layout-segment-context-384G2cAa.js"];
...
function getDraftSecret() {
	return "35cb271c-107e-4e3d-ba24-d84f1c656e3e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d64545c8-576f-4b18-9d36-c54c198c34d3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d64545c8-576f-4b18-9d36-c54c198c34d3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d64545c8-576f-4b18-9d36-c54c198c34d3",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	...
	description: "نموذج تفاعلي لتطبيق Aura لحجز جلسات البيلاتس واليوغا في المراكز القريبة.",
	openGraph: {
		title: "Aura",
		description: "نموذج تفاعلي حديث لتطبيق حجوزات مراكز البيلاتس واليوغا.",
		type: "website"
	},
	icons: {
		icon: "/favicon.svg",
